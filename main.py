...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}](https://t.me/Final_piece)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text4 == '/d':
        ...
        cptoken = "cptoken"
        pwtoken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..onQwEU2de6hLWcJuS-nwa7r7zjRoTgxHS9vJiWhi6tA'
    else:
        cwtoken = raw_text4
        cptoken = raw_text4
        pwtoken = raw_text4
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://cpapi-rjbs-1l0p.onrender.com/extract_keys?url={url}@bots_updatee&user_id={1184922780}"
                ...
                response = requests.get(f"https://cpapi-rjbs-1l0p.onrender.com/extract_keys?url={url}@bots_updatee&user_id={1184922780}")
